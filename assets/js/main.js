/* =========================================================================
   InmoElite · Madrid — interacciones
...
(() => {
  ...
  if (spy.length && sections.length) {
    ...
    /* Las imágenes en carga diferida y el <details> del FAQ cambian el alto
       de las secciones después del primer medido, y los offsetTop cacheados
  ...
  const rot = $("#rotWord");
  if (rot && !reduced) {
    const words = ["comprar", "vender", "alquilar", "valorar tu casa", "invertir"];
    let i = 0;
    setInterval(() => {
